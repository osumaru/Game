...
bool CEquipItem::Start()
{
	//片手剣の初期化
	{
		...
		swprintf(ItemStatus[3].ItemText, L"鋼で作られた剣。騎士や\n兵隊長など上位職の者が\n愛用している。");
		...
		swprintf(ItemStatus[4].ItemText, L"魔力が込められた剣。一\n部の上流階級のみが所持し\nている。");
		...
		swprintf(ItemStatus[7].ItemText, L"さび付いた剣。かなりの年\n月が経っており武器としては\nほとんど意味をなさない。");
		...
		swprintf(ItemStatus[8].ItemText, L"一般的な片手剣。主に歩兵\nが愛用している。");
	...
	//両手の初期化
	{
		...
		swprintf(ItemStatus[11].ItemText, L"バスターソード。グレート\nソードと同じく、敵を粉砕するために作\nられた強力な大剣。");
		...
		swprintf(ItemStatus[12].ItemText, L"クレイモア。重たい一撃手歩\n兵を粉砕する大剣。");
		...
		swprintf(ItemStatus[13].ItemText, L"ツヴァイハンダー。振り回すこ\nとにより、より強力な一撃を放つ。");
		...
		swprintf(ItemStatus[14].ItemText, L"騎士の大剣。兵隊長や王の側近の\n兵が身に着けている。");
		...
		swprintf(ItemStatus[15].ItemText, L"炎の大剣。炎の魔力が込められた大剣。");
		...
		swprintf(ItemStatus[16].ItemText, L"氷の大剣。氷の魔力が込められた大剣。");
		...
		swprintf(ItemStatus[17].ItemText, L"雷の大剣。雷の魔力が込められた大剣。");
		...
		swprintf(ItemStatus[18].ItemText, L"丸太。武器のとしての実用性はない\nが、これを振り回す筋力は計\nり知れない。");
		...
		swprintf(ItemStatus[19].ItemText, L"国の英雄のみに贈られる大剣。一振り\nで周囲の敵を粉砕する強\n力な力を秘めている。");
