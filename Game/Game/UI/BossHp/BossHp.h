...
private:
	...
	const CVector2	m_bossHpPos = { 620.0f,270.0f };		//ボスのHP座標
	CVector2		m_bossHpSize = { -300.0f,40.0f };		//ボスのHPサイズ
	const CVector2	m_bossHpCenterPos = { 0.0f,1.0f };		//ボスのHP基点座標
	...
	const CVector2	m_bossHpBackPos = { 620.0f,270.0f };	//ボスのHPバックグラウンド座標
	CVector2		m_bossHpBackSize = { -300.0f,40.0f };	//ボスのHPバックグラウンドサイズ
	const CVector2	m_bossHpBackCenterPos = { 0.0f,1.0f };	//ボスのHPバックグラウンド基点座標

	int				m_bossHp = 100;							//ボスのHPの値
	int				m_bossHpSizeUp = 3;						//ボスのHPの大きさを調整する用の変数
	float			m_bossMaxHp = 100;						//ボスの最大Hp
