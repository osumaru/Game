...
private:
	...
	CFont			 m_statusFont[CEquipInventory::enStatus_Num];					//現在の装備と装備変更時のステータス文字
	CFont			 m_statusFontNum[CEquipInventory::enStatus_Num];					//現在の装備と装備変更時のステータス数値
